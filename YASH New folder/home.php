		...
		function test_input($data)
			...
			if(isset($_POST['submit']))
			{
				...
				if($_SERVER["REQUEST_METHOD"] == "POST")
				{
					...
					if($board<60)
						echo "Colleges won't accept your application board marks are greter than 60";
					else
					{
						$avg = (($board*60) + ((($jee*100)/360)*40))/100;
						if($avg>87)
							echo "You are eligible to apply for Indian Institute of Technology BOMBAY<br>";
						if($avg>77)
							echo "You are eligible to apply for National Institute of Technology NAGPUR<br>";
					    if($avg<77)
							echo "You are eligible to apply for  DY PATIL AKURDI ,
						     also You are eligible to apply for  PCCOE College <br>";
						if($bits>99)
							echo "You are eligible to apply for COEP<br>";
						    
						if($bits>98)
							echo "You are eligible to apply for VIIT<br>";
						if($bits>97)
							echo "You are eligible to apply for MIT ALANDI<br>";
						if($bits>96)
							echo "You are eligible to apply for AIISMS College of Engg. <br>";
						if($bits>95)
							echo "You are eligible to apply for JSPM Rajarshi Shahu College of Engg. <br>";
						if($bits>94)
							echo "You are eligible to apply for I2IT Hinjewadi<br>";
						if($bits>93)
							echo "You are eligible to apply for Sinhagad college of Engg. Vadgaon  <br>";
						if($srm>140)
