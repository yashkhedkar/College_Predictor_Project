...
<body>
	<nav class="navbar sticky-top navbar-expand-sm navbar-dark bg-dark">
    	...
    	<img src="jagran_logo1.jpg" width="50" height="60" class="d-inline-block align-top" alt=""> College Sikhsha
  		</a>
  <!-- Links -->
	...
	<div class="background">
		...
		<form method="post" action="home.php">
			<div id="center">
				...
				<input class="ip" type="text" name="jee" placeholder="JEE Score (Percentile)" required><br><br>
				<input class="ip" type="text" name="cet" placeholder="MHTCET Score (Percentile)"><br><br>
